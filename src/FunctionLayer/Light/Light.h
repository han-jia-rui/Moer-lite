...
class InfiniteLight : public Light {
  public:
    ...
    //! 该接口不应当被调用
    virtual Spectrum evaluateEmission(const Intersection &,
                                      const Vector3f &) const override final {
        std::cerr << "InfiniteLight::evaluateEmission(Intersection, Vector3f) "
